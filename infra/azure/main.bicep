...
@description('Set to true on first deployment when images do not exist in ACR yet')
...
// Container images — use a lightweight public image on first deploy before ACR has images
