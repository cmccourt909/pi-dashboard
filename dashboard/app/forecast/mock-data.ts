...
export const MOCK_ROADMAP: APIRoadmapResponse = {
  features: [
    { issue_key: "EVIONEP-1770", summary: "Historical Data Handling - SQL Layer", status: "Implementing", status_category: "indeterminate", assignee: "R. Sharma", target_start_date: "2026-01-05", target_end_date: "2026-05-29", story_total: 10, story_done: 8, story_in_progress: 1, story_todo: 1, pct_complete: 80.0 },
    { issue_key: "EVIONEP-1774", summary: "SQL Case Details Integration", status: "In Progress", status_category: "indeterminate", assignee: "M. Patel", target_start_date: "2026-02-01", target_end_date: "2026-06-12", story_total: 9, story_done: 5, story_in_progress: 2, story_todo: 2, pct_complete: 55.6 },
